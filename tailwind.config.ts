	...
	theme: {
      ...
      fontFamily: {
        ...
        'slide-indicator': {
          ...
          '100%': { transform: 'translateX(var(--slide-to)) scale(1)', opacity: '0.9' },
        },
        'glow': {
        ...
        'slide-indicator': 'slide-indicator 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)',
        'glow': 'glow 2s ease-in-out infinite',
        'bounce-in': 'bounce-in 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55)',
        'magnetic-snap': 'magnetic-snap 0.3s ease-out',
			}
		}
	},
